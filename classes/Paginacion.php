...
class Paginacion{
    ...
    public function enlaceAnterior(){
        ...
        if($this->paginaAnterior()){
            $html .= '<a class="paginacion__enlace
            paginacion__enlace--texto" href="?page='.$this->paginaAnterior().'"> &laquo; Anterior</a>';
        }
        return $html;
    ...
    public function enlaceSiguiente(){
        ...
        if($this->paginaSiguiente()){
            $html .= '<a class="paginacion__enlace
            paginacion__enlace--texto" href="?page='.$this->paginaSiguiente().'">Siguiente &raquo</a>';
